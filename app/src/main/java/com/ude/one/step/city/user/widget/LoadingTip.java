    ...
    public void setLoadingTip(LoadStatus loadStatus){
        switch (loadStatus){
            case empty:
                ...
                tv_tips.setText(getContext().getText(R.string.load_empty).toString());
                img_tip_logo.setImageResource(R.mipmap.ic_launcher);
                break;
            case sereverError:
                setVisibility(View.VISIBLE);
                img_tip_logo.setVisibility(View.VISIBLE);
                ...
                if (TextUtils.isEmpty(errorMsg)){
                    tv_tips.setText(getContext().getText(R.string.error_fail).toString());
                }else {
            ...
            case error:
                ...
                progress.setVisibility(View.GONE);
                if (TextUtils.isEmpty(errorMsg)){
                    tv_tips.setText(getContext().getText(R.string.error_network).toString());
                }else {
                    tv_tips.setText(errorMsg);
                }
                img_tip_logo.setImageResource(R.mipmap.ic_launcher);
